...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/usuario/neworupdate").hasRole("ADMIN")
				.antMatchers("/usuario/newUser").hasRole("ADMIN")
				.antMatchers("/usuario/editUser/").hasRole("ADMIN")
				.antMatchers("/usuario/delete/*").hasRole("ADMIN")
				.antMatchers("/listarPersonasyRodados").hasRole("ADMIN")
